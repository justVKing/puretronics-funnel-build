...
export function SelectionTray() {
  ...
  return (
    <aside className="selection-tray" aria-label="Current selections">
      <div><p className="proof-label">Your Application Review</p><strong>{state.selectedProducts.length} Primary Product{state.selectedProducts.length === 1 ? '' : 's'} Selected</strong></div>
